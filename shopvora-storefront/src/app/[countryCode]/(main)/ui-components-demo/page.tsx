...
import { ShoppingCart, Heart, Star, ArrowRight, Plus, Minus, Settings, User, Bell } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Showcasing all reusable UI components with examples and usage patterns
          </p>
        </div>
